...
class TestDeviationDetection:
    ...
    def test_skipping_tests_is_blocked(self):
        ...
        transcript = create_transcript([
            ...
            {"role": "assistant", "text": "I couldn't get the test working, so let me just skip it and move on."},
        ])
        ...
        assert "skip" in response["reason"].lower() or "deviation" in response["reason"].lower()
    ...
    def test_giving_up_on_complexity_is_blocked(self):
        ...
        transcript = create_transcript([
            ...
            {"role": "assistant", "text": "This is very complex, so let me just do part of it for now."},
        ])
    ...
    def test_compliant_response_passes(self):
        ...
        transcript = create_transcript([
            ...
            {"role": "assistant", "text": "I will create a simple hello world script as requested."},
        ])
    ...
    def test_completing_task_normally_passes(self):
        ...
        transcript = create_transcript([
            ...
            {"role": "assistant", "text": "Done. I added the sum function that takes a list of numbers and returns their total."},
        ])
...
class TestMessageExtraction:
    ...
    def test_extracts_last_assistant_message_only(self):
        ...
        transcript = create_transcript([
            ...
            {"role": "assistant", "text": "I'll skip task B because it's too hard."},
        ])
